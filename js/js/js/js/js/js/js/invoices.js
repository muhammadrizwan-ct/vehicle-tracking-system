...
<body>
    ...
    <div class="invoice-container">
        ...
        <div class="invoice-content">
            ...
            <!-- COMPANY DETAILS - REMOVED AS PER LETTERHEAD -->
            ...
            <table class="items-table">
                <thead>
                    <tr>
                        ...
                        <th width="15%" style="text-align: right;">Tax (19.5%)</th>
            ...
            <!-- FOOTER SECTION REMOVED - WILL BE PRINTED ON LETTERHEAD -->
        </div>
    </div>
    ...
    if (invoice.items && invoice.items.length > 0) {
        if (invoice.invoiceType === 'summary') {
            ...
            Object.keys(categories).sort().forEach(category => {
                ...
                rows += `<td><strong>${category}</strong></td>`;
            ...
            invoice.items.forEach(item => {
                ...
                rows += `<td><strong>${item.registrationNo || 'Service'}</strong></td>`;
        ...
        rows += `<td><strong>Monthly Service</strong></td>`;
